...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? ??? ????? 01101 11", lui    , U, R(dest) =SEXTU(BITS(src1, 31, 0), 32));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw   , I, R(dest) =(int64_t)(((uint32_t) src1) >> SEXTU(BITS(src2, 4, 0), 5)) ); 
  INSTPAT("0000000 ????? ????? 001 ????? 00110 11", slliw   , I, R(dest) =(int64_t)(((uint32_t) src1) << SEXTU(BITS(src2, 4, 0), 5)) ); 
  ...
  INSTPAT("??????? ????? ????? 100 ????? 11000 11", blt    , B,printf("src1:%ld",src1); printf("src2:%ld",src2);if((signed)src1<(signed)src2) s->dnpc=dest+s->pc);
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 0111011", subw    , R, R(dest) = (int64_t)((uint32_t)src1 - (uint32_t)src2));  
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 0111011", divuw    , R, R(dest) = (int64_t)((uint32_t)src1/(uint32_t)src2));  
  INSTPAT("0000001 ????? ????? 111 ????? 0111011", remuw    , R, R(dest) = (int64_t)((uint32_t)src1%(uint32_t)src2));  
