...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw   , I, R(dest) =(signed)(((int32_t) src1) >> SEXTU(BITS(src2, 4, 0), 5)) ); 
  INSTPAT("0000000 ????? ????? 001 ????? 00110 11", slliw   , I, R(dest) =(signed)(((int32_t) src1) << SEXTU(BITS(src2, 4, 0), 5)) ); 
