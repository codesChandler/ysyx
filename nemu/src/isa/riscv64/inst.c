...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00110 11", addiw  , I, R(dest) = (int64_t)(signed)((uint32_t)src1 + (uint32_t)src2));
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, printf("src1:%lx\n",(src1));printf("src1:%lx after shift\n",((int64_t) (signed) src1) >> SEXTU(BITS(src2, 5, 0), 6));R(dest) =((signed) src1) >> SEXTU(BITS(src2, 5, 0), 6););
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 0111011", divw    , R,printf("divw-src1:%lx\n",(src1));printf("divw-src2:%lx\n",(src2));printf("divw-src1/src2(32):%x\n",((int32_t)src1/(int32_t)src2));printf("divw-src1/src2(64):%lx\n",(int64_t)((int32_t)src1/(int32_t)src2)); R(dest) = (int64_t)((int32_t)src1/(int32_t)src2));   
