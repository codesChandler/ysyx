...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(dest) =((int64_t) src1) >> SEXTU(BITS(src2, 5, 0), 6) );
  INSTPAT("000000? ????? ????? 001 ????? 00100 11", slli   , I, R(dest) =((uint64_t) src1) << SEXTU(BITS(src2, 4, 0), 5) );  
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srli   , I, R(dest) =((uint64_t) src1) << SEXTU(BITS(src2, 5, 0), 6) );  
