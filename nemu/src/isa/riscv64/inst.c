...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 0111011", sllw    , R, R(dest) = (int64_t)(signed)((int32_t)src1) << SEXTU(BITS(src2, 4, 0), 5));
  INSTPAT("0000001 ????? ????? 000 ????? 0111011", mulw    , R, R(dest) = (int64_t)(signed)((int32_t)src1*(int32_t)src2));  
  INSTPAT("0000001 ????? ????? 100 ????? 0111011", divw    , R, R(dest) = (int64_t)(signed)((int32_t)src1/(int32_t)src2));   
