...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00110 11", addiw  , I, printf("addiw src1:%d",(uint32_t)src1);printf("addiw src2:%d",(uint32_t)src2);printf("addiw src1+src2:%d",((uint32_t)src1 + (uint32_t)src2));printf("addiw src1+src2:%ld",(int64_t)(signed)((uint32_t)src1 + (uint32_t)src2));R(dest) = (int64_t)(signed)((uint32_t)src1 + (uint32_t)src2));
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, printf("src1:%ld srai\n",(src1));printf("src2:%ld srai\n",SEXTU(BITS(src2, 5, 0), 6));printf("src1:%d srai after shift\n",((signed) src1) >> SEXTU(BITS(src2, 5, 0), 6));R(dest) =((signed) src1) >> SEXTU(BITS(src2, 5, 0), 6);printf("R(dest):%ld srai after shift\n",R(dest)););
