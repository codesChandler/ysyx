...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(dest) =((signed) src1) >> SEXTU(BITS(src2, 5, 0), 6));
  ...
  INSTPAT("??????? ????? ????? 001 ????? 11100 11", csrrw   , I,R(dest) =Cr(src2);Cw(src2,src1);); 
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall , N, s->dnpc=isa_raise_intr(0xb, s->pc));// 按照difftest应设置0xb,按照nanos-lite应设置成1
